...
/**
 * Class cvchekout_Public_Woocommerce_Template
 */
class cvchekout_Public_Woocommerce_Template
{
	...
	public function edit_paypal_icon($icon_html, $gateway_id){
		if('paypal' == $gateway_id){
			$icon_html = '<img src="';
			$icon_html .= cvchekout_PLUGIN_URL_PATH . '/public/img/paypal_icon.png"';
			$icon_html .= 'width="30" height="30"';
			$icon_html .= 'alt="' . __('Paypal acceptance mark', 'cvchekout') . '">';
		}
		return $icon_html;
	}
}	
