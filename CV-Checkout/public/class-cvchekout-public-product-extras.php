...
class cvchekout_Public_Product_Extras
{
    /**
    ...
    public function pewc_add_addons_parameters( $group_key, $item_key, $item, $post_id ) {
        ...
        <div class="pewc-fields-wrapper pewc-my-new-fields">
            <div class="product-extra-field-third">
                <label> <?php _e('Display name in cart', 'cvchekout'); ?></label>
                <input type="text" 
    ...
    public function cvchekout_update_gift_message(){
        global $woocommerce;
    ...
    public function cvchekout_delete_gift_option(){
        global $woocommerce;
        if( 
            isset($woocommerce->cart->cart_contents[$_POST['product_key']]) &&
            isset($woocommerce->cart->cart_contents[$_POST['product_key']]['product_extras'])
    ...
    public function cvchekout_add_gift_option(){
        global $woocommerce;
